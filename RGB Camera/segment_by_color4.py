...
cv.createTrackbar('Hmin','Thresholds',0,200,dummy)
cv.createTrackbar('Hmax','Thresholds',0,200,dummy)
cv.createTrackbar('S', 'Thresholds',0,100,dummy)
cv.createTrackbar('V', 'Thresholds',0,100,dummy)
